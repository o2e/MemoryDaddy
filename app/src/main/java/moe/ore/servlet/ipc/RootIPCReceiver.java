...
import moe.ore.memory.IRootIPC;
...
public abstract class RootIPCReceiver<T> {
     ...
     */
    public abstract void onConnect(@NonNull T ipc);
     ...
     * @param ipc The Binder interface you declared in an aidl and passed to RootIPC on the root side
     */
    public abstract void onDisconnect(@NonNull T ipc);

    static final String BROADCAST_ACTION = "moe.ore.process.RootIPCReceiver.BROADCAST";
    static final String BROADCAST_EXTRA = "moe.ore.process.RootIPCReceiver.BROADCAST.EXTRA";
